const Header = () => {
    return (
        <header className="w-full max-w-6xl mx-auto bg-card border border-border rounded-xl p-3 sm:p-4 crypto-card mt-4 mb-6">
            <div className="flex items-center gap-4 sm:gap-8">
                <a href="#" className="flex gap-2 flex-shrink-0 text-primary hover:text-primary/80 text-2xl sm:text-3xl transition-colors">
                    <svg
                    ...
                    <span className="bitcoin-accent font-semibold">CryptoSky</span>
                </a>
